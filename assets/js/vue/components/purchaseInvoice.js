                ...
                <div class="row">
                    <div class="col-xs-6">
                        ...
                        <table class="pull-left">
                            <tr>
                                <td><strong>  {{ purchase.previous_due < -1 ? 'Advance Amount' : 'Previous Due ' }} :</strong></td>
                                
                                <td style="text-align:right">{{ purchase.previous_due == null ? '0.00' : purchase.previous_due < -1 ? (purchase.previous_due * -1) : purchase.previous_due  }}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td><strong> {{(parseFloat(purchase.previous_due) + parseFloat(purchase.PurchaseMaster_DueAmount == null ? 0.00 : purchase.PurchaseMaster_DueAmount)) < -1 ? 'Balance ' : 'Total Due '}} </strong></td>
                                
                                <td style="text-align:right" v-if="(parseFloat(purchase.previous_due) + parseFloat(purchase.PurchaseMaster_DueAmount == null ? 0.00 : purchase.PurchaseMaster_DueAmount)) < -1 ">
                                    {{ ((parseFloat(purchase.previous_due) + parseFloat(purchase.PurchaseMaster_DueAmount == null ? 0.00 : purchase.PurchaseMaster_DueAmount)) * -1).toFixed(2) }}
                                </td>
                                <td style="text-align:right" v-else>{{ (parseFloat(purchase.previous_due) + parseFloat(purchase.PurchaseMaster_DueAmount == null ? 0.00 : purchase.PurchaseMaster_DueAmount)).toFixed(2) }}</td>
                            </tr>
                        </table>
                    </div>
                    <div class="col-xs-6">
