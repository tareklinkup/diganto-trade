                        ...
                        <table _a584de>
                            ...
                            <tbody>
                                <tr v-for="(product, sl) in cart">
                                    ...
                                    <td>{{ product.discount_qty }} {{ product.Unit_Name }}</td>
                ...
                <div class="row">
                    <div class="col-xs-6">
                        ...
                        <table class="pull-left">
                            <tr>
                                <td><strong> {{ sales.SaleMaster_Previous_Due < -1 ? 'Advance Amount' : 'Previous Due' }} :</strong></td>
                                
                                <td style="text-align:right">{{ sales.SaleMaster_Previous_Due == null ? '0.00' : sales.SaleMaster_Previous_Due < -1  ?  (sales.SaleMaster_Previous_Due * -1) : sales.SaleMaster_Previous_Due }}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td><strong> {{ parseFloat(sales.SaleMaster_Previous_Due) + parseFloat(sales.SaleMaster_DueAmount == null ? 0.00 : sales.SaleMaster_DueAmount) < -1 ? 'Balance ' : 'Total Due ' }} :</strong></td>
                                
                                <td style="text-align:right" v-if="parseFloat(sales.SaleMaster_Previous_Due) + parseFloat(sales.SaleMaster_DueAmount == null ? 0.00 : sales.SaleMaster_DueAmount) < -1">

                                    {{ ((parseFloat(sales.SaleMaster_Previous_Due) + parseFloat(sales.SaleMaster_DueAmount == null ? 0.00 : sales.SaleMaster_DueAmount)) * -1).toFixed(2) }}

                                </td>
                                <td style="text-align:right" v-else>{{ (parseFloat(sales.SaleMaster_Previous_Due) + parseFloat(sales.SaleMaster_DueAmount == null ? 0.00 : sales.SaleMaster_DueAmount)).toFixed(2) }}</td>
                            </tr>
                        </table>
                    </div>
                    <div class="col-xs-6">
