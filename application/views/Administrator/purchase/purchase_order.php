						...
						<div class="col-sm-6">
							<form v-on:submit.prevent="addToCart">
								...
								<div class="form-group">
									...
									<div class="col-sm-3">
										<input type="text" id="productTotal" name="productTotal" class="form-control" v-model="selectedProduct.discount_qty"/>
									</div>
								</div>
				...
				<table class="table table-bordered" style="color:#000;margin-bottom: 5px;">
					<thead>
						<tr>
							...
							<th style="width:5%;color:#000;">Shinkrag</th>
									...
									<tr>
										<td>
											<div class="form-group">
												...
												<div class="col-sm-12">
													<input type="number" id="subTotal" name="subTotal" class="form-control" v-model="purchase.advanceAmount" readonly />
												</div>
											</div>
										</td>
									</tr>
				...
				axios.post('/get_supplier_due', {supplierId: this.selectedSupplier.Supplier_SlNo}).then(res => {
					if(res.data.length > 0){
						if(res.data[0].due > 0)
							...
							this.purchase.advanceAmount = res.data[0].due * -1;
					} else {
