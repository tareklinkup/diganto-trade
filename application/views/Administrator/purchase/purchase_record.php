					...
					<tbody>
						<template v-for="purchase in purchases">
							<tr>
								...
								<td style="text-align:right;">{{ purchase.purchaseDetails[0].discount_qty }}</td>
							...
							<tr v-for="(product, sl) in purchase.purchaseDetails.slice(1)">
								...
								<td style="text-align:center;">{{ product.discount_qty }}</td>
							...
							<tr style="font-weight:bold;">
								...
								<td style="text-align:center;">Total Shinkrag<br>{{ purchase.purchaseDetails.reduce((prev, curr) => {return prev + parseFloat(curr.discount_qty)}, 0) }}</td>
