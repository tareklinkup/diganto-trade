        ...
        <div class="row" style="margin-bottom: 20px;">
            <div class="col-xs-12 text-left;">
                <table style="width: 25%;float:left;">
                    ...
                    <tr>
                        <td style="font-size: 13px; font-weight: 600; "> <?php echo $totalDue < -1 ? 'Advance' : 'Current Due' ?> : </td>
                        <td style="font-size: 13px; font-weight: 600; text-align: right; "><?php echo $totalDue < -1 ? number_format(($totalDue * -1),2) : number_format($totalDue,2); ?></td>
                    </tr>
                </table>
