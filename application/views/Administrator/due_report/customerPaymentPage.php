			...
			<form @submit.prevent="saveCustomerPayment">
				<div class="row">
					<div class="col-md-5 col-md-offset-1">
						...
						<div class="form-group">
							<label class="col-md-4 control-label"> {{ payment.CPayment_previous_due > 0 ? ' Due ' : ' Advance ' }}</label>
							<label class="col-md-1">:</label>
							<div class="col-md-7">
								<input type="text" v-if="payment.CPayment_previous_due > 0" class="form-control" v-model="payment.CPayment_previous_due" readonly>
								<input type="text" v-else class="form-control" v-model="payment.CPayment_previous_due *-1" readonly>
							</div>
						</div>
					</div>
