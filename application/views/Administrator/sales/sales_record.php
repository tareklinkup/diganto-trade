					...
					<tbody>
						<template v-for="sale in sales">
							<tr>
								...
								<td style="text-align:center;">{{ sale.saleDetails[0].discount_qty }}</td>
							...
							<tr style="font-weight:bold;">
								...
								<td style="text-align:center;">Total Shinkrag<br>{{ sale.saleDetails.reduce((prev, curr) => {return prev + parseFloat(curr.discount_qty)}, 0) }}</td>
